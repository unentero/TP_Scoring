...
case numpag of
  0: begin
    colocar('1     No respetar indicaciones Autoridad dirige Tránsito                                                  ', 15, 10, 10);
    colocar('2     Conducir con Licencia Vencida o Caduca                                                              ', 15, 10, 11);
    colocar('3     Licencia o documentación habilitante vencida (transporte público)                                   ', 15, 10, 12);
    colocar('4     Conducir sin anteojos o lentes contacto según Licencia                                              ', 15, 10, 13);
    ...
    colocar('8     Sistemas o dispositivos de retención infantil                                                       ', 15, 10, 17);
    colocar('9     No uso cinturón de seguridad                                                                        ', 15, 10, 18);
    ...
    colocar('12    Marcha atrás en forma indebida                                                                      ', 15, 10, 21);
    colocar('13    Obstruccion de via (en carriles exclusivos y metrobus y premetro)                                   ', 15, 10, 22);
    colocar('14    Obstruir vía Transversal,Ciclovía,Vereda,Estac. reservado                                           ', 15, 10, 23);
    colocar('15    Obstruir lugar reservado Vehíc. Persona discapac. RAMPA discapac.                                   ', 15, 10, 24);
    case index of
    1: colocar_res('1     No respetar indicaciones Autoridad dirige Tránsito', 1, 10, 10);
    2: colocar_res('2     Conducir con Licencia Vencida o Caduca', 1, 10, 11);
    3: colocar_res('3     Licencia o documentación habilitante vencida (transporte público)', 1, 10, 12);
    4: colocar_res('4     Conducir sin anteojos o lentes contacto según Licencia', 1, 10, 13);
    ...
    8: colocar_res('8     Sistemas o dispositivos de retención infantil', 1, 10, 17);
    9: colocar_res('9     No uso cinturón de seguridad', 1, 10, 18);
    ...
    12:colocar_res('12    Marcha atrás en forma indebida', 1, 10, 21);
    13:colocar_res('13    Obstruccion de via (en carriles exclusivos y metrobus y premetro)', 1, 10, 22);
    14:colocar_res('14    Obstruir vía Transversal,Ciclovía,Vereda,Estac. reservado', 1, 10, 23);
    15:colocar_res('15    Obstruir lugar reservado Vehíc. Persona discapac. RAMPA discapac.', 1, 10, 24);
    end;
  ...
  1: begin
     ...
     colocar('20    Circulación en sentido contrario                                                                   ', 15, 10, 14);
     colocar('21    Invasión parcial de vías                                                                           ', 15, 10, 15);
     colocar('22    No respetar paso o cartel PARE en bocacalle                                                        ', 15, 10, 16);
     colocar('23    Interrumpir Filas Escolares                                                                        ', 15, 10, 17);
     colocar('24    Prohibido circular según DÍA,HORA,CARAC.VEHIC y.u OCUPANTES (MOTO)                                 ', 15, 10, 18);
     colocar('25    Infracción régimen motovehículos                                                                   ', 15, 10, 19);
     colocar('26    Violar Luz Roja                                                                                    ', 15, 10, 20);
     colocar('27    Violacion de semáforos (taxis, escolares , pasajeros, remises. Prestando servicio)                 ', 15, 10, 21);
     colocar('28    Exceso de velocidad de 10% a 30% ms de la velocidad permitida                                      ', 15, 10, 22);
     colocar('29    No Cumplir Normas sin requisitos Vehículos de Transporte con habilitación                          ', 15, 10, 23);
     colocar('30    Requisitos de los vehículos de transporte de carga sin habilitación                                ', 15, 10, 24);
    case index of
    ...
    5: colocar_res('20    Circulación en sentido contrario', 1, 10, 14);
    6: colocar_res('21    Invasión parcial de vías', 1, 10, 15);
    7: colocar_res('22    No respetar paso o cartel PARE en bocacalle', 1, 10, 16);
    8: colocar_res('23    Interrumpir Filas Escolares', 1, 10, 17);
    9: colocar_res('24    Prohibido circular según DÍA,HORA,CARAC.VEHIC y.u OCUPANTES (MOTO)', 1, 10, 18);
    10:colocar_res('25    Infracción régimen motovehículos', 1, 10, 19);
    11:colocar_res('26    Violar Luz Roja', 1, 10, 20);
    12:colocar_res('27    Violacion de semáforos (taxis, escolares , pasajeros, remises. Prestando servicio)', 1, 10, 21);
    13:colocar_res('28    Exceso de velocidad de 10% a 30% ms de la velocidad permitida', 1, 10, 22);
    14:colocar_res('29    No Cumplir Normas sin requisitos Vehículos de Transporte con habilitación', 1, 10, 23);
    15:colocar_res('30    Requisitos de los vehículos de transporte de carga sin habilitación   ', 1, 10, 24);
    end;
  end;
  2: begin
    colocar('31    Violación de barreras ferroviarias                                                                  ', 15, 10, 10);
    colocar('32    Violación de límites de velocidad mayor al 30% permitido                                            ', 15, 10, 11);
    colocar('33    Requisitos de los vehículos de transporte de carga                                                  ', 15, 10, 12);
    colocar('34    Placas de dominio                                                                                   ', 15, 10, 13);
    colocar('35    Circular con antiradar o antifoto                                                                   ', 15, 10, 14);
    colocar('36    Conducción peligrosa                                                                                ', 15, 10, 15);
    ...
    colocar('39    Taxis, transporte de escolares, remises, vehículos de fantasía sin autorización                     ', 15, 10, 18);
    ...
    case index of
    1: colocar_res('31    Violación de barreras ferroviarias', 1, 10, 10);
    2: colocar_res('32    Violación de límites de velocidad mayor al 30% permitido', 1, 10, 11);
    3: colocar_res('33    Requisitos de los vehículos de transporte de carga', 1, 10, 12);
    4: colocar_res('34    Placas de dominio', 1, 10, 13);
    5: colocar_res('35    Circular con antiradar o antifoto', 1, 10, 14);
    6: colocar_res('36    Conducción peligrosa', 1, 10, 15);
    ...
    9: colocar_res('39    Taxis, transporte de escolares, remises, vehículos de fantasía sin autorización', 1, 10, 18);
...
begin
     titulo (' Infraccion ');
           r.DNI:=x;
           colocar('|Fecha Infraccion: '+(FormatDateTime('(dd/mm/yyyy)'+'|',Date)),green,30,6);
